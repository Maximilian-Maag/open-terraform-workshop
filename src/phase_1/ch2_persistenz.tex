...
\begin{document}
    \begin{center}
        \Large \textbf{Challange 2: Persistenz} \\ [6pt]
        \normalsize
        Autor: Maximilian Jakob Maag B.Sc. \\
        Version: 1.0
    \end{center}
    \section{Intro}
    Wenn Terraform ein Element - z.B. eine Firewall, VPS, o.ä - provisioniert, dass bereits existiert, wird das bestehende Element zerstört und ein neues
    Element provisioniert. Das kann dazu führen, dass Produktionsdaten oder Konfigurationen verlorgen gehen, wenn man nicht aufpasst.
    \section{Aufgaben}
    In dieser Übung sollen Sie einige VPS Instanzen deployen und konfigurationen. Danach werden Sie diese abändern.
    ...
    Ändern Sie eine Kleinigkeit an Ihrer Terraformkonfiguration z.B. die RAM Größe Ihres VPS  von 4 auf 8 GB.
    Deployen sie Ihre Änderung mittels Terraform apply. \\ \\
