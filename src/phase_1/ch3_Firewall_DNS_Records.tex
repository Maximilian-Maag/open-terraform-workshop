...
\begin{document}
    \begin{center}
        \Large \textbf{Challange 3: DNS Records und Firewall} \\ [6pt]
        \normalsize
    ...
    \section{Intro}
        ...
        Diese Übung setzt vorraus, dass sie einen Mailserver  deployen können. \\ \\
    ...
    \section{Aufgaben}
        In dieser Challange ist es Ihr Ziel passend zu Ihrem Mailserver dessen DNS Records mittels Terraform zu setzen und
    ...
    \subsection{Aufgabe 1}
        ...
        Anschließend destroyen sie diesen wieder, damit er nicht ungeschützt im Internet erreichbar ist.
    
    \subsection{Aufgabe 2}
        Erstellen die Config für eine Firewall. Blockieren Sie zunächst sämtlichen Inbound und Outboundtraffic.
