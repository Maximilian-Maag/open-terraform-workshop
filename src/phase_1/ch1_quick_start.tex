...
\begin{document}
    ...
    Diese Challange soll Ihnen helfen das gezeigte Setup selbst einzurichten. \\ \\
    Bei Terraform handelt es sich um eine IAC Lösung, man spricht von Infrastructure as Code. Infrastruktur wird als Software behandelt uns Sie schreiben Programme die Infrastruktur deployen können.
    Für ein funktionierendes Setup benötigen Sie also typische Werkzeuge eines Softwareprojekts.
    \begin{itemize}
        \item Eine VCS Lösung, Version Controle System.
    ...
    \section{Aufgaben}
    Nachdem Sie alle  nötigen Arbeitsmaterialien zurecht gelegt haben können Sie die Challange beginnen.
    ...
    Auf dem Testsystem des Kickoffs wurde Linode als Provider gewhält.
    Es gibt aber noch andere Provider. Finden Sie mindestens drei von Ihnen und erarbeiten Sie einen sinnvollen Preisvergleich.
    ...
    Erstellen Sie einen API Token bei einem Terraformprovider  Ihrer wahl.
    \\ \\
