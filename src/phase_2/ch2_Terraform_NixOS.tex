...
\begin{document}
    ...
    \end{center}
    \section{Intro}
    Terraform ist hervoragend,  um Infrastruktur zu provisonieren. Allerdings ist es meist unproduktiv ein Element einer Infrastruktur zu zerstören und neu anzulegen, 
    ...
    Der Sollzustand, z.B: immer die neuste Version eines Pakets zu installieren oder Updates lassen sich super automatisieren.

    \section{Aufgaben}
    Diese Challange soll mehere Welten mit einander Verbinden. Terraform als Werkzeug für Provisionierung und NixOS für Wartungsaufgaben auf einem VPS.
    ...
    Erstellen Sie eine NixOS config, welche einen Benutzer hinzufügt. Außerdem soll ein Webserver installiert werden.
    Sie Können die NixOS config auch von einer KI erzeugen lassen. \\ \\
    Verbinden Sie sich mittels SSH mit ihrem deployten VPS und wenden Sie NixOS config an. Überprüfen Sie die Anwendung, indem Sie den Webserver aufrufen.
